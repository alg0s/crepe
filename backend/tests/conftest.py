        ...
        [
            {
                ...
                "importance": "high",
                "mentions": [{"mentioned": {"user": {"id": "u2", "displayName": "Bob Tran"}}}],
            ...
            },
            {
                ...
                "importance": "normal",
                "mentions": [{"mentioned": {"user": {"id": "u1", "displayName": "Alice Wong"}}}],
                "reactions": [{"reactionType": "like", "user": {"id": "u1"}}],
            },
            {
                "id": "m3",
        ...
        [
            {
                ...
                "importance": "high",
                "mentions": [{"mentioned": {"user": {"id": "u1", "displayName": "Alice Wong"}}}],
                "reactions": [{"reactionType": "sad", "user": {"id": "u1"}}],
            },
            {
                "id": "m5",
                ...
                "from": {"user": {"id": "u1", "displayName": "Alice Wong"}},
                "importance": "high",
                "mentions": [{"mentioned": {"user": {"id": "u3", "displayName": "Cara Lim"}}}],
                "reactions": [{"reactionType": "angry", "user": {"id": "u3"}}],
            },
            {
                "id": "m6",
        ...
        [
            {
                ...
                "importance": "normal",
                "mentions": [{"mentioned": {"user": {"id": "u3", "displayName": "Cara Lim"}}}],
                "reactions": [{"reactionType": "like", "user": {"id": "u3"}}],
            },
            {
                "id": "cm2",
            ...
            },
            {
                ...
                "importance": "high",
                "mentions": [{"mentioned": {"user": {"id": "u3", "displayName": "Cara Lim"}}}],
                "reactions": [{"reactionType": "sad", "user": {"id": "u3"}}],
            },
        ],
        {"chat_id": "chat-1"},
    )
